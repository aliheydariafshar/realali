        ...
        <header id="site_header" class="header mobile-menu-hide">
            <div class="header-content">
                <div class="header-photo">
                    <img src="{{\Illuminate\Support\Facades\URL::asset('assets/img/IMG_20210817_200602_601-01.jpeg')}}" alt="علی حیدری">
                </div>
            ...
            <div class="header-buttons">
                <a href="{{\Illuminate\Support\Facades\URL::asset('assets/myfiles/MyResume (2).pdf')}}" target="_blank"
                                ...
                                <form class="contact-form" action="{{route('message.store')}}" method="Post">
                                    ...
                                    <div class="controls two-columns">
                                        ...
                                        <div class="g-recaptcha"
                                             data-sitekey="6Lc0K8IZAAAAAHYXAOlFp2bdaoKp732BBMuypqKX"></div>
